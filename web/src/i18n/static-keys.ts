...
export const STATIC_I18N_KEYS = [
  ...
  'Email (optional)',
  'Administrators use the 5,000-trillion-point system plan',
  'Changing the account type automatically switches the monthly free plan',
  'Accounts can only be created by administrators',
  'Public password registration is disabled',
] as const
