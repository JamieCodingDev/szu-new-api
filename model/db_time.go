...
func GetDBTimestamp() int64 {
	return getDBTimestampWithTx(DB)
}

// getDBTimestampWithTx obtains database time through the caller's connection.
// This avoids opening a second connection while a SQLite transaction is held.
