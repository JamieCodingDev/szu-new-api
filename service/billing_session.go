...
func (s *BillingSession) reserveFunding(delta int) error {
	...
	case *WalletFunding:
		// Retry-group top-ups use the same atomic balance guard as initial
		// pre-consumption. A more expensive route must not make the wallet
		// negative after the original estimate has already been reserved.
