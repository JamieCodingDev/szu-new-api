...
func TestPrepareTieredBillingForSelectedGroupRejectsInsufficientTopUpWithoutNegativeBalance(t *testing.T) {
	truncate(t)
	...
	// The retry must be rejected without changing the remaining wallet.
	...
	// The failed reservation does not advance the billing snapshot or wallet.
...
func TestWalletSettlementRejectsInsufficientDeltaWithoutNegativeBalance(t *testing.T) {
	truncate(t)
